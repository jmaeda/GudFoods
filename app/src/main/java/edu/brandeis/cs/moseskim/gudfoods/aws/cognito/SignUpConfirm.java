...
//            confCode.setBackground(getDrawable(R.drawable.text_border_error));
        ...
        AWSService.getPool().getUser(userName).confirmSignUpInBackground(confirmCode, true, confHandler);
    }
...
//            username.setBackground(getDrawable(R.drawable.text_border_error));
        ...
        AWSService.getPool().getUser(userName).resendConfirmationCodeInBackground(resendConfCodeHandler);
...
//            confCode.setBackground(getDrawable(R.drawable.text_border_error));
            ...
            showDialogMessage("Confirmation failed", AWSService.formatException(exception), false);
        }
    };
...
//            username.setBackground(getDrawable(R.drawable.text_border_error));
            showDialogMessage("Confirmation code request has failed", AWSService.formatException(exception), false);
        }
    };
